...
src = 'C:/Users/PC00/Desktop/score/metrics/resultimg/test1/';
% image_folder = 'C:/Users/PC00/Desktop/score/metrics/resultimg/test4';
...
for n = 1:N
    ...
    for i = 1:n_dis
        svrmodel = ficsvm(label_train{i}, feature_train{i}, '-s 4 -q');
        svrmodels{n,i} = svrmodel;
    end
    svcmodel = ficsvm(label_train_svc, x_train, '-s 0 -b 1 -q -c 1e4 -g 1e-4');
